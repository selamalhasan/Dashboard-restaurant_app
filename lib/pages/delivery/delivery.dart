...
class _DeliveryState extends State<Delivery> {
  ...
  void getDatedelivery(int count, String strSearch) async {
    loadingList = true;
    setState(() {});
    deliveryList = await getDelivery(
        count,
        "http://127.0.0.1/restaurant-app/api/delivery/read_delivery.php",
        strSearch);
    loadingList = false;
    setState(() {});
  }
  ...
  void initState() {
    ...
    super.initState();
    _appBarTitle = new Text("Delivery");
    ...
    if (this._searchIcon.icon == Icons.search) {
      ...
      this._appBarTitle = new TextField(
        ...
        onChanged: (text) {
          deliveryList.clear();
          i = 0;
          getDatedelivery(0, text);
          myProv.add_loading();
        },
      );
    } else {
      this._searchIcon = new Icon(Icons.search);
      this._appBarTitle = new Text("Delivery");
    }
    myProv.add_loading();
  }
